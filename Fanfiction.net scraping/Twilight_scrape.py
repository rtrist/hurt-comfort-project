...
url = "https://www.fanfiction.net/book/Twilight/?&srt=4&g1=20&r=10&p={}"

with open('Twilight_Genres.csv', 'a', newline='', encoding='utf-8') as csv_file:
    csv_writer = csv.writer(csv_file)


    for page in range(1022, 1041):
      url = url.format(page)
    ...
    print("All genres have been scraped and saved to 'Twilight_Genres.csv'.")
