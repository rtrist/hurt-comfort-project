...
url = "https://www.fanfiction.net/anime/Naruto/?&srt=4&g1=20&r=10&p={}"

with open('Naruto_Genres.csv', 'a', newline='', encoding='utf-8') as csv_file:
    csv_writer = csv.writer(csv_file)


    for page in range(1, 1462):
      url = url.format(page)
    ...
    print("All genres have been scraped and saved to 'Naruto_Genres.csv'.")
